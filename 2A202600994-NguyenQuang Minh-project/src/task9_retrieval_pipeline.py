...
SCORE_THRESHOLD = 0.02   # Nếu best score < threshold → fallback PageIndex
DEFAULT_TOP_K = 5
...
def retrieve(
    ...
    """
    # Step 1: Song song chạy/tuần tự semantic + lexical
    ...
    if not final_results or final_results[0]["score"] < score_threshold:
        ...
        try:
            ...
            print(f"  ⚠ PageIndex search failed or not implemented: {e}. Returning empty list.")
            return []
